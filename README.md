...
% echo 'Touching `mod.rs` should cause re-run of `build-script-tango-build`, but does not.'
Touching `mod.rs` should cause re-run of `build-script-tango-build`, but does not.
